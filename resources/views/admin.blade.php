...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Bảo Lộc</span>
            </a>
            <ul class="dropdown-menu">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Room</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{url('/accounts/submitroom')}}">Nhập Loại Phòng</a></li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>LokNet &copy; 2017 <a href="{{route('home')}}">Company</a></strong> 
  </footer>
...
<script type="text/javascript" src="{{asset('/assets/js/apartment.js')}}"></script>
