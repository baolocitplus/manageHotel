					...
					<nav id="main-menu">
						<ul class="list-inline">
							...
							<li class="active"><a href="#">Gallery</a>
								<ul>
									<li class="active"><a href="gallery-grid.html">Gallery - Grid View</a></li>
		...
		<section id="breadcrumb-section" data-bg-img="../assets/img/breadcrumb.jpg">
			<div class="inner-container container">
				<div class="ravis-title">
					<div class="inner-box">
						<div class="title">Gallery - Grid</div>
				...
				<div class="breadcrumb">
					<ul class="list-inline">
						...
						<li class="current"><a href="#">Gallery - Grid</a></li>
					</ul>
				</div>
			</div>
		</section>
					...
					<ul class="image-main-box clearfix">
						...
						<li class="item col-xs-6 col-md-4 bars">
							<figure>
								...
								<a href="../assets/img/gallery/3.jpg" class="more-details" data-title="Neat &amp; Clean Places">Enlarge</a>
								<figcaption>
